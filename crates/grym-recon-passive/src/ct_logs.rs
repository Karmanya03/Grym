...
pub fn generate_subdomain_permutations(domain: &str) -> Vec<String> {
    let prefixes = [
        ...
        "test", "portal", "app", "m", "mobile", "beta", "demo", "shop",
        "support", "help", "docs", "dashboard", "monitor", "backup",
        "git", "jenkins", "jira", "confluence", "wiki", "status",
        "static", "assets", "img", "css", "js", "media", "download",
        "downloads", "ftp", "ssh", "mysql", "db", "database", "redis",
        "cache", "proxy", "gateway", "router", "firewall", "auth",
        "login", "register", "signup", "signin", "logout", "account",
        "pay", "payment", "checkout", "cart", "orders", "invoice",
        "track", "tracking", "chat", "livechat", "talk", "phone",
        "video", "conf", "meet", "calendar", "clock", "time",
        "upload", "files", "cloud", "sync", "data", "analytics",
        "metrics", "logs", "report", "reports", "search", "index",
        "sitemap", "robots", "crossdomain", "clientaccesspolicy",
        "soap", "ws", "xmlrpc", "graphql", "rest", "api/v1", "api/v2",
        "v1", "v2", "stage", "prod", "production", "development",
        "release", "nightly", "build", "ci", "cd", "deploy",
        "internal", "external", "public", "private", "corp",
        "partner", "partners", "vendor", "vendors", "reseller",
        "wholesale", "retail", "store", "billing", "subscribe",
        "newsletter", "news", "info", "about", "contact", "feedback",
        "survey", "polls", "jobs", "careers", "hr", "intranet",
        "ldap", "radius", "vpn", "rdp", "telnet", "tftp",
        "sip", "voip", "fax", "printer", "print", "scan",
        "nagios", "zabbix", "grafana", "prometheus", "kibana",
        "elastic", "elasticsearch", "logstash", "solr", "splunk",
        "kafka", "rabbitmq", "activemq", "artemis", "mq",
        "registry", "docker", "k8s", "kubernetes", "istio",
